...
POS_CAR.center = WIDTH//100*20, HEIGHT//100*60
CAR_RIGHT = POS_CAR[0]+CAR_WIDTH

CAR_2 = pygame.image.load('img/lvl3/car_crashed_2.png').convert_alpha()
CAR_2_WIDTH = CAR_2.get_width()
POS_CAR_2 = CAR_2.get_rect()
POS_CAR_2.center = WIDTH//100*20, HEIGHT//100*60
...
HEART = pygame.image.load('img/lvl3/heart.png').convert_alpha()
