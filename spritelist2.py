...
ST_OFFSET_TUNNEL = WIDTH+100
ST_OFFSET_ANSWER = WIDTH+120

TUNNEL = pygame.image.load('img/lvl1/tunnel.png').convert_alpha()
POS_TUNNEL_0 = TUNNEL.get_rect()
POS_TUNNEL_0.center = ST_OFFSET_TUNNEL, HEIGHT//100*46
POS_TUNNEL_1 = TUNNEL.get_rect()
POS_TUNNEL_1.center = ST_OFFSET_TUNNEL, HEIGHT//100*66
POS_TUNNEL_2 = TUNNEL.get_rect()
POS_TUNNEL_2.center = ST_OFFSET_TUNNEL, HEIGHT//100*88
