...
from spritelist_2 import *
from osts import *


pygame.display.set_caption('LVL2')
...
for exercise in range(10):
    ...
    second_sum = random.randint(0, 49)
...
while run:
    ...
    if ROAD_LANES == 0:
        POS_CAR[1] = HEIGHT//100*45
        # print(ROAD_LANES)
    elif ROAD_LANES == 1:
        POS_CAR[1] = HEIGHT//100*65
        # print(ROAD_LANES)
    elif ROAD_LANES == 2:
        POS_CAR[1] = HEIGHT//100*85
        # print(ROAD_LANES)
    elif ROAD_LANES > 2:
        ROAD_LANES = 2
    elif ROAD_LANES < 0:
